...
public class ContentDownloader {
    ...
    public ContentDownloader(Context context, Activity activity, 
    ...
    public void downloadFileFromUrl(String url, int requestCode) {
        ...
        try {
            ...
            callback.onDownloadFailed("Could not create temporary file: " + e.getMessage(), requestCode);
            return;
        }
        ...
        new Thread(() -> {
            try {
                ...
                if (connection.getResponseCode() != HttpURLConnection.HTTP_OK) {
                    callback.onDownloadFailed("Server returned HTTP " + connection.getResponseCode(), 
                                            requestCode);
                    return;
                }
                ...
                callback.onDownloadFailed("Download failed: " + e.getMessage(), requestCode);
            }
        }).start();
    }
}