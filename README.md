...
[![Windows snapshot build](https://img.shields.io/github/workflow/status/exult/exult/snapshots-windows?label=Windows%20Snapshot%build&logo=windows&logoColor=white)](https://github.com/exult/exult/actions?query=workflow%3Asnapshots-windows)
