...
[![CodeQL](https://img.shields.io/github/actions/workflow/status/exult/exult/codeql.yml?label=CodeQL&logo=github&logoColor=white)](https://github.com/exult/exult/actions/workflows/codeql.yml)

[![CI Ubuntu 20.04](https://img.shields.io/github/actions/workflow/status/exult/exult/ci-linux.yml?label=CI%20Ubuntu&logo=Ubuntu&logoColor=white)](https://github.com/exult/exult/actions/workflows/ci-linux.yml)
[![CI Mac OS Catalina 10.15](https://img.shields.io/github/actions/workflow/status/exult/exult/ci-macos.yml?label=CI%20Mac%20OS%20X&logo=Apple&logoColor=white)](https://github.com/exult/exult/actions/workflows/ci-macos.yml)
[![CI Windows Server 2019](https://img.shields.io/github/actions/workflow/status/exult/exult/ci-windows.yml?label=CI%20Windows&logo=Windows&logoColor=white)](https://github.com/exult/exult/actions/workflows/ci-windows.yml)
[![CI Android](https://img.shields.io/github/actions/workflow/status/exult/exult/ci-android.yml?label=CI%20Android&logo=Android&logoColor=white)](https://github.com/exult/exult/actions/workflows/ci-android.yml)
[![CI iOS](https://img.shields.io/github/actions/workflow/status/exult/exult/ci-ios.yml?label=CI%20iOS&logo=iOS&logoColor=white)](https://github.com/exult/exult/actions/workflows/ci-ios.yml)

[![Coverity Scan Analysis](https://img.shields.io/github/actions/workflow/status/exult/exult/coverity-scan.yml?label=Coverity%20Scan%20Analysis&logo=data:image/svg+xml;base64,)](https://github.com/exult/exult/actions/workflows/coverity-scan.yml)
...
[![Windows snapshot build](https://img.shields.io/github/actions/workflow/status/exult/exult/snapshots-windows.yml?label=Windows%20Snapshot%20build&logo=windows&logoColor=white)](https://github.com/exult/exult/actions/workflows/snapshots-windows.yml)
