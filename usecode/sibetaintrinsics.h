...
USECODE_INTRINSIC_PTR(get_random),                               // 0x00
		...
		USECODE_INTRINSIC_PTR(
				UNKNOWN),    // 0x5f - UNUSED - Same as BG 0x4e/SI 0x60?
		...
		USECODE_INTRINSIC_PTR(
				UNKNOWN),    // 0x77 - UNUSED - Seems like it could be
							 // set_orrery, but does nothing
		USECODE_INTRINSIC_PTR(UNKNOWN),    // 0x78 - UNUSED - Same as BG 0x64/SI
										   // 0x79? Something with palettes
		...
		USECODE_INTRINSIC_PTR(UNKNOWN),    // 0x9c - UNUSED - Same as BG 0x83/SI
										   // 0x9b? Something with palettes
